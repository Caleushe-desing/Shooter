...
export function buildHavenInspiredMap(): { props: PropBox[]; solids: SolidBox[] } {
  ...
  props.push(
    ...
    { x: -3, y: 0.55, z: 8, w: 1.6, h: 1.1, d: 1.6, color: COLORS.wood, surface: 'wood', solid: true },
    { x: 3.2, y: 0.55, z: 9, w: 1.4, h: 1.1, d: 1.4, color: COLORS.wood, surface: 'wood', solid: true },
    { x: -2.2, y: 0.9, z: -2, w: 1.2, h: 1.8, d: 1.2, color: COLORS.stone, surface: 'stone', solid: true },
    { x: 2.5, y: 0.7, z: -3, w: 2, h: 1.4, d: 1.1, color: COLORS.wood, surface: 'wood', solid: true },
  )
